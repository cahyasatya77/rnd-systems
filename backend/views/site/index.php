...
<?php if(Yii::$app->user->idDept == 'D0001') : ?>
    <?php if (Yii::$app->user->level == 'manager') :?>
        <div class="row">
            <div class="col-md-6">
                <h3 class="text-success">R&D Systems</h3>
                <?= Html::img(Yii::$app->urlManager->baseUrl.'/img/home-alien 1.svg', ['class' => 'img-fluid pt-5'])?>
            </div>
            <div class="col-lg-6">
                <!-- <h1 class="text-success">R&D Systems</h1> -->
                
                <div class="divider-text">Komitmen Registasi</div>
                <div class="row">
                    <div id="mydiv" class="col-md-6 col-sm-3 col-xs-12" style="cursor: pointer;">
                    ...
                    <div id="appreview" class="col-md-6 col-sm-3 col-xs-12" style="cursor: pointer;">
                        <div class="info-box shadow">
                    ...
                    <div id="appjustif" class="col-md-6 col-sm-3 col-xs-12" style="cursor: pointer;">
                        <div class="info-box shadow">
                ...
                <div class="row">
                    <div id="appmeeting" class="col-md-6 col-sm-3 col-xs-12" style="cursor: pointer;">
                        <div class="info-box shadow">
                            <span class="info-box-icon bg-info"><i class="fas fa-bookmark"></i></span>
                    ...
                    <div id="reviewmeeting" class="col-md-6 col-sm-3 col-xs-12" style="cursor: pointer;">
                        <div class="info-box shadow">
                            <span class="info-box-icon bg-teal"><i class="fas fa-user-check"></i></span>
                    ...
                    <div id="appjustifmeeting" class="col-md-6 col-sm-3 col-xs-12" style="cursor: pointer;">
                        <div class="info-box shadow">
                            <span class="info-box-icon bg-purple"><i class="fas fa-check-double"></i></span>
        ...
        <?php if (Yii::$app->user->idSection == 'D0001SC001') : ?>
            <div class="row">
                <div class="col-md-6">
                    ...
                    <!-- <p class="pt-2">
                        <h4 class="text-secondary">Welcome to Research And Development Systems</h4>
                        <strong>PT. IFARS Pharmaceutical Laboratories.</strong>
                    </p> -->
                    <div class="divider-text pt-4">Komitmen Registasi</div>
                    <div class="row">
                        <div id="mydiv" class="col-md-6 col-sm-3 col-xs-12" style="cursor: pointer;">
                            <div class="info-box shadow">
                        ...
                        <div id="reviewkom" class="col-md-6 col-sm-3 col-xs-12" style="cursor: pointer;">
                            <div class="info-box shadow">
                    ...
                    <div class="row">
                        <div id="meetingrevisi" class="col-md-6 col-sm-3 col-xs-12" style="cursor: pointer;">
                            <div class="info-box shadow">
                                <span class="info-box-icon bg-danger"><i class="fas fa-history"></i></span>
        ...
        <div class="row">
            <div class="col-lg-6" style="padding-top: 80px;">
                ...
                <div class="row pt-4">
                    ...
                    <div id="appjustifmeeting" class="col-md-6 col-sm-3 col-xs-12" style="cursor: pointer;">
                        <div class="info-box shadow">
                            <span class="info-box-icon bg-teal"><i class="fas fa-check-double"></i></span>
            ...
            <div class="col-md-6" style="padding-top: 50px;">
                <?= Html::img(Yii::$app->urlManager->baseUrl.'/img/home-alien 1.svg', ['class' => 'img-fluid'])?>
            </div>
        </div>
    <?php else : ?>
...
<?php if ((Yii::$app->user->level != 'manager') and (Yii::$app->user->idSection != 'D0001SC001')) :?>
    <div class="row">
...
$js = <<<JS
    ...
    $(document).ready(function() {
        $(".col-md-6.col-sm-3.col-xs-12").on("mouseenter", function() {
