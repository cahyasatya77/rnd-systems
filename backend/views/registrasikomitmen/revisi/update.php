...
$this->title = 'Update Revisi : ' . $model->nama_obat;
$this->params['breadcrumbs'][] = ['label' => 'Registrasikomitmens', 'url' => ['indexrevisi']];
$this->params['breadcrumbs'][] = ['label' => $model->nama_obat, 'url' => ['viewrevisi', 'id' => $model->nama_obat]];
