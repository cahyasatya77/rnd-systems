...
$this->params['breadcrumbs'][] = ['label' => 'Meetingregistrasis', 'url' => ['index']];
...
<?php else :?>
    <div class="row">
    <div class="col-md-12">
        <?php if (($model->id_status == 12) || ($model->id_status == 13)) :?>
            <?= Html::a('Create Evaluasi Reg', ['createeval', 'id' => $model->id], ['class' => 'btn btn-success btn-block'])?>
        <?php endif;?>
    </div>
    </div>
    <br>
