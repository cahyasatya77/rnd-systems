        ...
        <div class="card card-outline card-primary">
            <div class="card-header">
                <div class="row text-center">
                    <div class="col-md-4 card-title">Dokumen</div>
                    <div class="col-md-3 card-title">Catatan</div>
                    <div class="col-md-2 card-title">PIC</div>
                    <div class="col-md-2 card-title">Deadline</div>
