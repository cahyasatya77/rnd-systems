...
/* @var $model common\model\Meetingdokumen */

$this->title = 'Revisi Dokumen';
$this->params['breadcrumbs'][] = ['label' => 'List Review', 'url' => ['indexreviewrndmanager']];
$this->params['breadcrumbs'][] = ['label' => 'Review', 'url' => ['reviewrndmanager', 'id' => $model->id]];
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-outline card-danger">
                <div class="card-body">
                    <?= $form->field($model, 'revisi_mng_rnd')->textarea(['rows' => 4])->label('Revisi')?>
                </div>
                <div class="card-footer">
                    <div class="row">
                        <div class="col-md-12">
                            <?= Html::a('Back', ['reviewrndmanager', 'id' => $model->id], ['class' => 'btn btn-danger'])?>
