...
/* @var $dataDraft yii\data\ActiveDataProvider */
/* @var $dataRevisi yii\data\ActiveDataProvider */
/* @var $dataWaiting yii\data\ActiveDataProvider */

$totalDraft = $dataDraft->getTotalCount();
...
?>
<div class="meetingjustifikasi-index">
                    ...
                    <?= GridView::widget([
                        ...
                        'columns' => [
                            ...
                            [
                                ...
                                'urlCreator' => function ($action, Meetingjustifikasi $model, $key, $index, $column) {
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-outline card-success <?= $totalWaiting == 0 ? 'collapsed-card' : '' ?>">
                <div class="card-header">
                    <div class="card-title">Waiting to Approve</div>
                    <!-- tools -->
                    <div class="card-tools">
                        <button type="button" class="btn btn-tool" data-card-widget="collapse">
                    ...
                    <?= GridView::widget([
                        ...
                        'columns' => [
                            ...
                            [
                                'header' => 'Status',
                                'value' => function ($model) {
                                    if ($model->status->deskripsi == 'kirim') {
