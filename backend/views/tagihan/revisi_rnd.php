...
$this->title = 'Revisi';
$this->params['breadcrumbs'][] = ['label' => 'review', 'url' => ['reviewrnd', 'id' => $model->id]];
$this->params['breadcrumbs'][] = ['label' => 'index', 'url' => ['indexreview']];
$this->params['breadcrumbs'][] = $this->title;
?>

<div class="regkomtindakan-form-revisi-rnd">
    <div class="row">
        <div class="col-md-12">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-outline card-warning">
                <div class="card-body">
                    <?= $form->field($model, 'revisi_rnd')->textarea();?>
                </div>
                <div class="card-footer">
                    <div class="row">
                        <div class="col-md-12">
                            <?= Html::a('Back', ['reviewrnd', 'id' => $model->id], ['class' => 'btn btn-danger'])?>
