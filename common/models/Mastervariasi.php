...
/**
 * This is the model class for table "master_variasi".
 *
 * @property int $id
 ...
 */
class Mastervariasi extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return $this->hasMany(Mastervariasidokumen::className(), ['id_master_variasi' => 'id']);
    }
}
